...
namespace BMT_DATN.Models
{
    ...
    public partial class BMT_DATNEntities : DbContext
    {
        public BMT_DATNEntities()
            : base("name=BMT_DATNEntities")
        {
        }
        ...
        public virtual ObjectResult<sp_dangnhap_Result> sp_dangnhap(string tendangnhap)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_dangnhap_Result>("sp_dangnhap", tendangnhapParameter);
        }
